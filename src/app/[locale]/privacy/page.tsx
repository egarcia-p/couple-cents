...
export const metadata = {
  title: "Privacy Notice - CoupleCents",
  description: "Privacy Notice for CoupleCents financial application",
};

export default function PrivacyPage() {
  const filePath = path.join(process.cwd(), "privacy-notice.md");
