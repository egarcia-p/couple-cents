  ...
  return (
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6 text-black">
        ...
        <div className="mb-4">
          <label htmlFor="isExpense" className="mb-2 block text-sm font-medium">
            Choose if is an Expense
          </label>
          <div className="relative mt-2 rounded-md">
            ...
            <div id="isExpense-error" aria-live="polite" aria-atomic="true">
              {state.errors?.isExpense &&
                state.errors.isExpense.map((error: string) => (
